...
The `scout.yaml` SHALL provide clear filters (positive/negative) and portal configurations to automate discovery triage.
...
The `evaluation.yaml` SHALL define a scoring system based on weighted dimensions.
