---
name: evaluate_roles
description: Perform strategic, high-rigor evaluation and scoring of job roles against the configured profile
---
...
- **Gaps**: Identify JD requirements NOT covered by the profile.
